...
class CI_Xmlrpc {
	...
	public function __construct($config = array())
	{
		...
		$this->xmlrpcstr['invalid_return'] = 'The XML data received was either invalid or not in the correct form.php for XML-RPC.  Turn on debugging to examine the XML data further.';
...
class XML_RPC_Values extends CI_Xmlrpc
{
	...
	//-------------------------------------
	// Encode time in ISO-8601 form.php.
	//-------------------------------------
